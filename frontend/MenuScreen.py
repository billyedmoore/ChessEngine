...
class MenuScreen(pygame.Surface):
    def __init__(self, app, w, h):
        ...
        self.buttons = [Button(self, button_pos[0][0],
                               button_pos[0][1],
                               button_pos[0][2],
                               button_pos[0][3],
                               text="play computer",
                               on_click=lambda: app.start_game(GameScreen(
                                   app, w, h, black_player=AIPlayer("b")))),
                        Button(self, button_pos[1][0],
                               button_pos[1][1],
                               button_pos[1][2],
                               button_pos[1][3],
                               text="pass and play",
